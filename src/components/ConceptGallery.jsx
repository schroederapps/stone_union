      ...
      <div className="wrap">
        ...
        <div className="concept-grid">
          <Reveal delay={80} className="concept-item concept-item-wide">
            <img src={`${import.meta.env.BASE_URL}images/studio-benches.jpg`} alt="Concept rendering of individual sculpting stations beneath a skylight, with shelves of finished stone pieces and dust filtration equipment." />
          </Reveal>
          <Reveal delay={160} className="concept-item">
            <img src={`${import.meta.env.BASE_URL}images/architecture-render.jpg`} alt="Architectural rendering by Schulhof Rashidi Architects of the William King Museum of Art in Abingdon, Virginia, an example of the firm's cultural-space work." />
